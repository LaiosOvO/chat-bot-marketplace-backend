...
openai.api_base = 'http://192.168.2.14:11434/v1'
openai.api_key = ''
...
class AudioPlayer:
    ...
    def _request_audio_thread(self):
        while True:
            ...
            response = requests.get("http://192.168.2.14:8000/api/voice/tts", params={"query": text})
...
def asr_request(prepared_file):
    url = "http://192.168.2.14:50000/api/v1/asr"
